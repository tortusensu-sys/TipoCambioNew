...
class ExchangeRateArgentinaDivisas extends ExchangeManager {
    constructor(data) {
        super(data)
    }
            ...
            if (objars.indexOf('Le pedimos disculpas, en estos momentos no se puede acceder al sitio del Banco de la Nación Argentina.') === -1) {
                if (objars.indexOf('No hay cotizaciones pendientes para esa fecha.') === -1) {
                    ...
                    if (isExistDate) {
                        ...
                        resultContext = this.getExchangeRates(datestart)
                        flag = true
                    }
                } else {
                ...
                if (!flag) {
                    resultContext.push({
                        ...
                        nomenclatura: 'ARS',
                        namePortal: 'Banco Central de la Nación Argentina (Divisas)'
                    })
                }
            } else {
                resultContext.push({
...
module.exports = ExchangeRateArgentinaDivisas
