...
class ExchangeRateChileUF extends ExchangeManager {
    constructor(data) {
        super(data)
    }
    ...
    async getExchangeRates(date) {
        try {
            ...
            if (objars.indexOf(idDate) !== -1) {
                ...
                if (idDate === 'gr_ctl01_Enero' || !value) {
                    ...
                    resultContext = await this.getExchangeRate_Chile(newDate)
                    flag = true
                }
            }
...
module.exports = ExchangeRateChileUF
